...
public class orderNumberDesc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_number_desc);
        ...
        setRandomNumbers(); // Initialize random numbers on activity creation
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(orderNumberDesc.this, MainActivity.class);
    ...
    private void showResultDialog() {
        ...
        String message = isDescending ? "Numbers are in descending order" : "Numbers are not in descending order";
